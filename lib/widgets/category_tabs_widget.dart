...
class CategoryNewsWidget extends StatelessWidget {
  CategoryNewsWidget({super.key, required this.tabs});
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TabBarView(
            ...
            List<Article> array = articles
                .where((element) =>
                    element.category.toLowerCase() == tab.toLowerCase())
                .toList();
                      ...
                      children: [
                        Card(
                          ...
                          child: SizedBox(
                            ...
                            height:
                                MediaQuery.of(context).size.width * 0.26 - 10,
